<template>
    <div class="wrapper">
        <img 
          src="http://www.dell-lee.com/imgs/vue3/user.png" alt=""
          class="wrapper__img"
        >
        ...
        <div class="wrapper__input">
            <input 
               class="wrapper__input__content" type="password" 
               placeholder="请输入密码"
               v-model="password"    
           />
        </div> 
...
<script>
    ...
    setup(){
        ...
        return {handleLoginClick,username,password,handleRegister,ensurement,show,toastMessage}
    }
}
</script>
